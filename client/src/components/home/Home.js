  ...
  return (
    ...
    <section className="main">
        ...
        <div className="chefs__container">
          ...
          <div className="chefs__card">
            ...
            <div className="chefs__data">
              ...
              <p className="chefs__description">Master Chefs in orietnal cousine</p>
            </div>
          </div>
          <div className="chefs__card">
            <div className="chefs__user">
          ...
          <div className="chefs__card">
            ...
            <div className="chefs__data">
              ...
              <p className="chefs__description">Best Sushi Cheft from Tokyo</p>
            </div>
          </div>
          {/* </Fade> */}
        </div>
      ...
      <div id="design" className="design">
        ...
        <a href="/contact" className="btn reserve__btn"> Book Table Now</a>
          </div>
        </div>
      ...
      <div id="socialmedia" className="socialmedia">
        <h3 className="socialmedia__header">Over 1500 satisfied customers</h3>
